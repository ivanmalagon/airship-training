...
export class HistogramWidget {
    ...
    _renderHeader() {
        ...
        return [
            h("h2", { class: 'as-histogram-widget__header' }, this.heading),
            h("p", { class: 'as-histogram-widget__description as-body' }, this.description),
        ];
    }
    _renderTooltip() {
    ...
    _renderClearBtn() {
        return (h("button", { class: 'as-btn as-btn--primary as-btn--s as-category-widget__clear', onClick: () => this._setSelection(null) }, "Clear selection"));
    }
